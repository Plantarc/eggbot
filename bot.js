  ...
  switch (args[0].toLocaleLowerCase()) {
    ...
    case "rulesegger":
          var rulesegg = new Discord.RichEmbed()
              ...
              .addField("```- 9.  Swearing is allowed in #memes and #mature```", " ￼ ")
              .addField("```- 10. Post server invites only in #advertisment```", " ￼ ")
              .addField("```- 11. No spamming.```", " ￼ ")
              .addField("```- 12. Discuss politics only in #politics, to join politics react to a message in #information.```", " ￼ ")
