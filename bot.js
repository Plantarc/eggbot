...
var fortunes = [
    ...
    "Congrats you've proven that you are in fact an egg with that question  (my answer is no eggling if you couldnt tell) https://vignette.wikia.nocookie.net/club-penguin-rewritten/images/f/fb/Sled_Racing_Clapping_%281%29.gif"
]; 
  ...
  switch (args[0].toLocaleLowerCase()) {
    ...
    case "eggbotnews":
         var eggbotnews = new Discord.RichEmbed()
             ...
             .setFooter("© Eggtown", "https://i.imgur.com/16FyOPh.png")
             .setTimestamp()
             .setImage("https://i.imgur.com/QvBPSMc.gif")
             .setURL("https://youtu.be/rf_Go9eLaAM")
             .addField("Egg Bot Version 2.4 has been released!", "_ _")
             .addField("- After a long two years, the long awaited version 2.4 of Egg Bot has been released to the public.", "_ _")
    ...
    break;
    case "mastacheef11":
      message.channel.sendMessage("Masta Cheef.")
    break;
  }
});
